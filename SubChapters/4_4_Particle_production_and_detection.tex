...
\item Modern accelerators reach 6.8\;TeV\appear{, \CDAlert[blue]{colliding 2 particle beams together}}%high-energy 
\implies{ collision energy reaches 13.6 TeV values}
%\item Modern accelerators reach 6.8\;TeV\appear{, either using a \CDAlert[blue]{2-beam collider} scheme} \appear{or a \CDAlert[red]{stationary target with one incident beam}}
\end{itemize}
