% !TEX root = ../aa_AiRa_All_slides-2025
...
\begin{itemize}[leftmargin = 0.5cm,itemsep = 1cm] \huge
    \item[] \hyperlink{1_1_a}{\Alert[blue]{\Isectiontitle}}
%    \item[] \hyperlink{2_1_a}{\CDAlert[red]{$\mathbb{2.}$ Molekyylien ja Kiinteiden Aineiden} \CDAlert[red]{Sidokset}}%\CDAlert[red]{\IIsectiontitle}
\item[] \hyperlink{2_1_a}{\CDAlert[red]{\IIsectiontitle}}
